...
> Note: Timers are not impacted yet, but may be in a future release of Bun.
...
> Info: Unlike in Jest, you can set the timezone multiple times at runtime and it will work.
