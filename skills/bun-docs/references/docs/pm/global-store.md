...
Source: https://bun.com/docs/pm/global-store
...
The global virtual store is **off by default**. It only applies to the [isolated linker](/docs/pm/isolated-installs); the hoisted linker does not use it.
