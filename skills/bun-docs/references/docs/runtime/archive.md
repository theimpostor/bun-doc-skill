...
Supported glob patterns (subset of [Bun.Glob](/docs/runtime/glob) syntax):
...
See [Bun.Glob](/docs/runtime/glob) for the full glob syntax including escaping and advanced patterns.
